		  ...
		  TextSpan(
            ...
            Column(
              children: [
                ...
                Text(
                  'In this mode you have 60min, but you must reach within 25m of the exact location the provided image came from. Your score is based only on the amount of time it took to reach the location relative to the radius limit. If you try to submit at the wrong location you get 0 points.'
                ),
              ],
            ),
            SizedBox(height: 16.0),
